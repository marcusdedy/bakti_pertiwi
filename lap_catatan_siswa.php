...
mysql_select_db($database_koneksi, $koneksi);
$query_rec_list_siswa = "SELECT * FROM siswa WHERE nonaktif='N' AND s_kd_kls='".$colname2_rec_tampil_catatan."' AND u_nama='".$_SESSION['nama']."'";
...
<div class="judul">
<h3><span class="glyphicon glyphicon-list-alt"></span> Daftar Catatan Siswa</h3>
</div>
<form class="well" id="form1" name="form1" method="get" action="">
<input type="hidden" name="page" value="lap_catatan_siswa" />
