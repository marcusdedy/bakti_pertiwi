...
<input type="hidden" name="page" value="tampil_nilai" />
...
<p><a class="btn btn-success" href="index.php?page=tambah_nilai">Tambah Nilai</a></p>
<table class="table table-bordered">
  ...
  <?php do { ?>
    <tr>
      ...
      <td><a href="index.php?page=edit_nilai&amp;n_id=<?php echo $row_rec_tampil_nilai['n_id']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
    </tr>
