...
<form class="well" action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    ...
    <tr>
      ...
      <td><span id="sprytextfield3">
              <input class="form-control" type="text" name="s_tgl_lhr" value="" size="15" placeholder="Tanggal Lahir"/>
              <a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.form1.s_tgl_lhr);return false;" ><img src="calender/calender.jpeg" alt="" name="popcal" width="34" height="29" border="0" align="absmiddle" id="popcal" /></a>
